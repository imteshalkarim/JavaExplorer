...
//Write a program to accept a number and display the square of the last digit.
 ...
 * 
 * We find the last digit of the number by taking its modulo with 10 and store
 * it in the lastDigit variable.
 * 
 * We calculate the square of the last digit by multiplying it with itself and
 * store it in the square variable.
 * 
